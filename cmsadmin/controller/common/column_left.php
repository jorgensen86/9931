...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/appliance')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_appliance'),
					'href'     => $this->url->link('catalog/appliance', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}

			if ($this->user->hasPermission('access', 'catalog/code_type')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_code_type'),
					'href'     => $this->url->link('catalog/code_type', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
