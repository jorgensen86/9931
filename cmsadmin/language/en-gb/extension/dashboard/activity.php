...
$_['text_activity_preorder_account']  = '<a href="customer_id=%d">%s</a> added a <a href="order_id=%d&filter_preorder=1">new pre-order</a>.';
$_['text_activity_order_guest']    = '%s created a <a href="order_id=%d">new order</a>.';
$_['text_activity_preorder_guest'] = '%s created a <a href="order_id=%d&filter_preorder=1">new pre-order</a>.';
