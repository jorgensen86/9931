<?php
// Heading
$_['heading_title']          = 'Ανακατεύθυνση BluePay(Απαιτείται SSL)';

// Text
$_['text_extension']         = 'Επεκτάσεις';
$_['text_success']           = 'Επιτυχία: Έχετε επεξεργαστεί τις πληροφορίες λογαρισμού ανακατεύθυνσης BluePay!';
$_['text_edit']              = 'Επεξεργασία Ανακατεύθυνσης BluePay (Απαιτείται SSL)';
...
// Entry
$_['entry_vendor']           = 'Κωδικός Λογαριασμού (ID)';
