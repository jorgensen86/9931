...
class ControllerJournal3Filter extends ModuleController {
	...
	protected function beforeRender() {
		...
		// Jorgensen Aplliance Filter
		if($this->config->get('module_appliance_status')) {
			$item = array(
				'title' => $this->language->get('filter_appliance_title'),
				'description' => $this->language->get('filter_appliance_text'),
				'display' => 'text',
				'input' => 'link',
