function journal_filter_url() {
	...
	$('input[data-filter-trigger]:checked, select[data-filter-trigger], input[data-filter-search]').each(function () {
		var $this = $(this);
...
jQuery(function ($) {
    ...
    // jorgensen handle global search
    let timeout = null;
    
    $(document).delegate('[data-filter-search]', 'input', function () {
